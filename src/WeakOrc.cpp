...
WeakOrc::WeakOrc(b2World *world, float x, float y)
    : WeakOrc::WeakOrc()
{
...
void WeakOrc::startContact(Body *body, b2Contact *)
{
    firstImpulse = true;
    if(body->name == "shot")
    {
...
void WeakOrc::endContact(Body *body, b2Contact *)
{
    if(body->name == "player")
    {
...
void WeakOrc::postSolve(Body * , b2Contact* , const b2ContactImpulse* impulse)
{
    if(firstImpulse)
    {
...
void WeakOrc::preSolve(Body *body , b2Contact *, const b2Manifold *)
{
    if(body->name == "player")
    {
